const renderInitialProduct = (
  products,
  productContainer,
  firstProductIndex,
  lastProductIndex
) => {
  const producntOnPage = products.slice(firstProductIndex, lastProductIndex);
  console.log("producntOnPage", producntOnPage);

  producntOnPage.forEach(({ id, photo, model, prices }) => {
