...
const appendProductCard = (product, сontainer) => {
  сontainer.append(product);
};

const renderProductCards = (products, сontainer) => {
  сontainer.innerHTML = " "; //очищение контейнира
  products.forEach((product) => {
    const card = renderProductCard(product);
    appendProductCard(card, сontainer);
  });
};
